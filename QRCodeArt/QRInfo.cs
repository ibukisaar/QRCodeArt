...
namespace QRCodeArt {
	public static class QRInfo {
		...
		/// [Version, ECCLevel]
		/// </summary>
		static readonly (int NumberOfDataBytes, int Numeric, int Alphanumeric, int Byte, int Kanji)[,] DataCapacityTable = {
			{ // Version 1
		...
		/// [Version, ECCLevel]
		/// </summary>
		static readonly (int ECCPerBytes, int BlocksInGroup1, int CodewordsInGroup1, int BlocksInGroup2, int CodewordsInGroup2)[,] ECCTable = {
			{ // Version 1
				(    7,    1,   19,    0,    0), // ECC = L
				(   10,    1,   16,    0,    0), // ECC = M
				(   13,    1,   13,    0,    0), // ECC = Q
